print("Loading m_taskwarrior_d module")

local M = {}
print("Created module table M")

M.task = require("m_taskwarrior_d.task")
print("Required m_taskwarrior_d.task module")

M.treesitter = require("m_taskwarrior_d.treesitter")
print("Required m_taskwarrior_d.treesitter module")

M.utils = require("m_taskwarrior_d.utils")
print("Required m_taskwarrior_d.utils module")

M.ui = require("m_taskwarrior_d.ui")
print("Required m_taskwarrior_d.ui module")

M._concealTaskId = nil
M.current_winid = nil
print("Initialized _concealTaskId and current_winid to nil")
...
print("Initialized _config table")
...
print("Defined M.sync_tasks function")
...
function M.edit_task()
  ...
  print("Opened popup for editing task")
...
print("Defined M.edit_task function")
...
print("Defined M.toggle_task function")

-- More functions and setup below...
...
print("Defined M.update_current_task function")
...
print("Defined find_next_index function")
...
function M.view_task()
  ...
  vim.fn["trim"](md_table)
  local markdown_preview_bufnr = vim.fn["markdown#util#create"](md_table, {})
  vim.cmd("setl noreadonly") -- Allow buffer modification
  vim.cmd("setl buftype=nofile") -- Necessary for markdown preview
  vim.cmd("setl filetype=markdown") -- Necessary for markdown preview
  print("Task view created successfully")
end
print("Defined M.view_task function")
